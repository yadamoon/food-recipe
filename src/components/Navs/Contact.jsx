  ...
  return (
    <div className="flex justify-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8 sm:grid-cols-2 w-2/3">
        <div className=" h-auto body-font bg-white text-gray-600 rounded-t text-center">
          <h1 className="text-2xl text-center text-teal-800"> Call Us</h1>
          <p>+251-932380202</p>
        </div>
        <div className=" h-28  body-font bg-white text-gray-600 rounded-t">
          <h1 className="text-2xl text-center text-teal-800"> Chat Live</h1>
        ...
        <div className=" h-5/5 body-font bg-white text-gray-600 rounded-t">
          <h1 className="text-2xl text-center text-teal-800">
            {' '}
            Ask a Question
          </h1>
