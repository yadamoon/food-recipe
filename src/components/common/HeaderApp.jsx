            ...
            <nav className="2xl:container 2xl:mx-auto sm:py-6 sm:px-7 py-5 px-4">
                ...
                <div className="flex justify-between ">
                    ...
                    <div className=" flex space-x-3 items-center">
                        ...
                        <img src="public/svg/cookware-svgrepo-com(2).svg" width={80} height={40} alt="" />
                        <h1 className=" font-normal text-3xl leading-6 text-gray-800 uppercase">food recipe</h1>
                    </div>
                    <div className="hidden sm:flex flex-row space-x-4">
                        <button className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 bg-gray-200 border border-teal-700 focus:outline-none focus:bg-teal-500 hover:bg-teal-300 hove:text-white duration-150 justify-center items-center">Sign Up</button>
                        <button className="rounded-md flex space-x-2 w-24 h-10 font-normal text-sm leading-3 text-white bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-teal-600 hover:bg-teal-600 duration-150 justify-center items-center">Sign In</button>
                    </div>
                    {/* Burger Icon */}
                ...
                <div id="MobileNavigation" className={`${show ? 'block' : 'hidden'} sm:hidden mt-4 mx-auto`}>
                    ...
                    <div className="flex flex-col gap-4 mt-4 w-80 mx-auto ">
                        <button className="rounded-md flex space-x-2 w-full h-10 font-normal text-sm leading-3 text-teal-700 bg-indigo-600 bg-opacity-0 hover:opacity-100 duration-100 border border-teal-700 focus:outline-none focus:bg-teal-200 hover:bg-teal-200 duration-150 justify-center items-center">Sign Up</button>
                        <button className="rounded-md flex space-x-2 w-full h-10 font-normal text-sm leading-3 text-white bg-teal-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-700 focus:bg-indigo-600 hover:bg-teal-600 duration-150 justify-center items-center">Sign In</button>
                    </div>
                </div>
            </nav>
        </div>
