    ...
    <div className="bg-white h-screen ">
      <div className="w-96 bg-teal-700  md:h-full flex-col justify-between hidden sm:flex ">
        ...
        <div className="px-8 mt-10">
          ...
          <div className="flex justify-center mt-48 mb-4 w-full">
            <div className="relative ">
              <div className="text-white bg-white absolute ml-4 inset-0 m-auto w-4 h-4">
                <i class="fa fa-search " aria-hidden="true"></i>
              </div>
              <input
                className="  focus:outline-none rounded w-full text-sm  bg-gray-300 pl-10 py-2"
                type="text"
                placeholder="Search"
              />
            </div>
        ...
        <div className="px-8 border-t border-gray-700">
          <ul className="w-full flex items-center justify-between bg-teal-700">
      ...
      >
        <div
          className="h-10 w-10 bg-teal-700 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer"
          id="mobile-toggler"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="px-8">
          ...
          <ul className="mt-12">
            <li className="flex w-full justify-between text-white hover:text-white cursor-pointer items-center mb-6">
              ...
              <div className="py-1 px-3 bg-white rounded text-white flex items-center justify-center text-xs">
                5
              </div>
            </li>
            <li className="flex w-full justify-between text-white hover:text-white cursor-pointer items-center mb-6">
          ...
          <div className="flex justify-center mt-48 mb-4 w-full">
            <div className="relative ">
              <div className=" text-black absolute ml-4 inset-0 m-auto w-4 h-4">
                <i class="fa fa-search" aria-hidden="true"></i>
              </div>
              <input
                className="  focus:outline-none rounded w-full text-sm  bg-gray-300 pl-10 py-2"
